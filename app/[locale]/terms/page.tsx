...
export const metadata = { title: "Syarat Layanan", description: "Syarat dan ketentuan layanan Kedai-Ku." }
...
<p>Dengan mendaftar, mengakses, atau menggunakan platform Kedai-Ku ("Layanan"), Anda menyetujui untuk terikat oleh Syarat Layanan ini ("Ketentuan"). Jika Anda tidak menyetujui Ketentuan ini, mohon untuk tidak menggunakan Layanan.</p>

<h2>2. Definisi</h2>
<p>"Kedai-Ku", "kami", atau "penyedia" merujuk pada penyelenggara platform Kedai-Ku. "Pengguna" atau "Anda" merujuk pada individu atau badan usaha yang mendaftar dan menggunakan Layanan. "Konten" merujuk pada data, informasi, dan materi yang Anda unggah ke Layanan.</p>
...
<p>Pengumpulan, penggunaan, dan perlindungan data pribadi diatur dalam <a href="/privacy">Kebijakan Privasi</a> kami, yang merupakan bagian tak terpisahkan dari Ketentuan ini. Kami memproses data pribadi sesuai dengan UU No. 27 Tahun 2022 tentang Perlindungan Data Pribadi (UU PDP).</p>

<h2>7. Hak Kekayaan Intelektual</h2>
<p>Kami memegang semua hak atas kode, desain, merek dagang, dan elemen Layanan. Anda mempertahankan kepemilikan atas Konten yang Anda unggah. Dengan mengunggah Konten, Anda memberi kami lisensi terbatas untuk memproses Konten tersebut semata-mata untuk menyediakan Layanan kepada Anda.</p>
...
<h2>12. Kontak</h2>
<p>Untuk pertanyaan terkait Ketentuan ini atau bantuan teknis, silakan hubungi kami via WhatsApp di <a href="https://wa.me/6285353111025">+62 853-5311-1025</a> atau email <a href="mailto:garyhardiansyah02@gmail.com">garyhardiansyah02@gmail.com</a>.</p>
`
