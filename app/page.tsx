...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-background">
      ...
      <footer className="border-t"><div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-8 text-sm text-muted-foreground sm:flex-row sm:px-6"><span>© 2026 Kasir-Ku. Semua hak dilindungi.</span><div className="flex items-center gap-4"><Link href="/help" className="hover:text-foreground hover:underline">Bantuan</Link><Link href="/terms" className="hover:text-foreground hover:underline">Syarat Layanan</Link><Link href="/privacy" className="hover:text-foreground hover:underline">Kebijakan Privasi</Link><span>POS cerdas untuk bisnis Indonesia 🇮🇩</span></div></div></footer>
    </main>
  )
}
