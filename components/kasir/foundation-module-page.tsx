...
const configs: Record<string, ModuleConfig> = {
  ...
  reservations: { title: "Reservasi", description: "Kelola booking dan waiting list.", resource: "reservations", fields: [{ key: "guestName", label: "Nama tamu", required: true }, { key: "guestPhone", label: "Telepon" }, { key: "partySize", label: "Jumlah tamu", type: "number" }, { key: "reservedAt", label: "Waktu", type: "datetime-local" }, { key: "status", label: "Status" }], columns: [{ key: "guest_name", label: "Tamu" }, { key: "guest_phone", label: "Telepon" }, { key: "party_size", label: "Tamu" }, { key: "reserved_at", label: "Waktu" }, { key: "status", label: "Status" }] },
}
