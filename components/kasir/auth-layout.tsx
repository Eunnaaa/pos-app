  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-[1.05fr_1fr]">
      <section className="relative hidden overflow-hidden bg-emerald-950 p-10 text-white lg:flex lg:flex-col">
        ...
        <Link href="/" className="relative flex items-center gap-3"><span className="flex size-10 items-center justify-center rounded-xl bg-emerald-500"><Store className="size-5" /></span><span className="text-xl font-bold">Kedai-Ku</span></Link>
      ...
      <section className="relative flex items-center justify-center bg-background px-4 py-10 sm:px-8">
        ...
        <div className="w-full max-w-md">
          <Link href="/" className="mb-10 flex items-center justify-center gap-2 lg:hidden"><span className="flex size-9 items-center justify-center rounded-xl bg-emerald-600 text-white"><Store className="size-5" /></span><span className="text-xl font-bold">Kedai-Ku</span></Link>
