...
type Contact = { id: string; code: string; name: string; email?: string; phone?: string; address?: string; notes?: string; contact_name?: string; payment_terms_days?: number; total_spend_amount?: string; store_credit_amount?: string; is_active: boolean }
